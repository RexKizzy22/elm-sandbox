...
{--| More Readable fullAdderTests but don't have unique test names on a particular level
...
{--| More Readable but has unique test names on each level
...
{--| helper rippleCarryAdderTests for Fuzz testing
